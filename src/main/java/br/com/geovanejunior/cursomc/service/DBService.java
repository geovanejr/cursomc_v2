...
public class DBService {
    ...
    public void instantiateTestDatabase() throws ParseException {
        ...
        Cidade cid4 = new Cidade(null, "Belo Horizonte", est17);
        Cidade cid5 = new Cidade(null, "Rio de Janeiro", est19);

        est20.getCidades().addAll(Arrays.asList(cid2, cid3));
        est17.getCidades().addAll(Arrays.asList(cid1, cid4));
        est19.getCidades().addAll(Arrays.asList(cid5));
