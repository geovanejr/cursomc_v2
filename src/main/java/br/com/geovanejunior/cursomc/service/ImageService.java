...
public class ImageService {
    ...
    public BufferedImage getJpgImageFromFile(MultipartFile uploadedFile) {
        ...
        if (!"jpg".equals(ext) && !"png".equals(ext)) {
            throw new FileS3Exception("Somente imagens JPG e PNG são permitidas");
        }
        ...
        try {
            ...
            throw new FileS3Exception("Erro ao ler arquivo");
        }
    }
    ...
    public InputStream getInputStrem(BufferedImage img, String extension) {
        ...
        try {
            ...
            throw new FileS3Exception("Erro ao ler arquivo: " + e.getMessage());
        }
    }
}
