...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("br.com.geovanejunior.cursomc.resources"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "API do curso Spring Boot, Hibernate, REST, Ionic, JWT, S3, MySQL, MongoDB",
                "Esta API é utilizada no curso Spring Boot, Hibernate, REST, Ionic, JWT, S3, MySQL, MongoDB, do prof. Nelio Alves",
                "Versão 1.0",
                "https://www.udemy.com/terms",
                new Contact("Geovane Junior", "", "geovane.gjunior@gmail.com"),
